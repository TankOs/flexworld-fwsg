...
int main() {
	...
	geometry.add_triangle(
		sg::Vertex( sf::Vector3f( 0, 0, 0 ), sf::Vector3f( 0, 0, 1 ), sf::Vector2f( 0, 0 ), sf::Color::Red ),
		sg::Vertex( sf::Vector3f( 1, 0, 0 ), sf::Vector3f( 0, 0, 1 ), sf::Vector2f( 0, 0 ), sf::Color::Green ),
		sg::Vertex( sf::Vector3f( 0, 1, 0 ), sf::Vector3f( 0, 0, 1 ), sf::Vector2f( 0, 0 ), sf::Color::Blue )
	);

	// Create the buffer object and load the geometry into it.
	sg::BufferObject::Ptr buffer_object( new sg::BufferObject( sg::BufferObject::COLORS, true ) );
